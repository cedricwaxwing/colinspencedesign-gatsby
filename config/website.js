module.exports = {
  pathPrefix: `/`,
  url: `https://colinspencedesign.com/`,
  email: `colinspencedesign@gmail.com`,
  phone: `(780) 217-9838`,
  ...
  shortName: `Colin Spence Design`, // shortname for manifest. *Must* be shorter than 12 characters
  themeColor: `#4a4a4a`,
  backgroundColor: `#F5F5F5`,

  // schema.org JSONLD
  headline: `The recent works of Colin Spence, currently happily employed at Teaching.com, building fun web expereinces for Typing.com.`,
  author: ``,

  // Google & Twitter
  googleAnalyticsId: `G-VH47R4F421`, // Google Analytics ID
